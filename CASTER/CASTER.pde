...
void draw(){
  ...
  //text(frameRate,width/2,height/2);
   if(img.img.files!=null&&img.img.progress<img.img.files.length){//hard code in file loading bar because I didnt feel like trying to shove it somewhere
      ...
      //Jesse: Array Index Out of Bounds Eception: 2; Jesse: Array Index Out of Bounds Exception: 8
      //This seems to happen sometimes when I'm loading a new stack and getting my brush set up?
